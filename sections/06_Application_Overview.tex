...
After initializing the next period of a game, the administrators can define some messages (same as in period zero / game initialization, \Cref{fig:starting_period_one}). On starting the next period, teams can then define their decisions as described for the previous screen.
\begin{figure}[h!]
  \centering
