...
\paragraph{Assets}
All assets are visible within this page which are available for all game master, as visible in figure~\ref{fig:assets}. They can be synchronized to the current definition within the market repository. When synchronizing those assets, they will be updated for all users. % TODO on what?
\begin{figure}[h!]
  \centering
