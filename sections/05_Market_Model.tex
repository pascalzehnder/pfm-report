...
\begin{table}[h!]
  \begin{tabular}{lp{11cm}}
    ...
    Name & Inputs \\
    \midrule
    ix\_returns & Average weighted return over the previous 5 periods\\
    \midrule
    ix\_sharpe\_ratio & Sharpe ratio of portfolios \\
    ix\_information\_ratio & Information ratio of portfolios \\
    ix\_performance & ix\_sharpe\_ratio, ix\_information\_ratio \\
    \midrule
    ix\_salary & Yearly salary given to employees \\
    ix\_education & Yearly days of education for each employee \\
    ix\_employee\_satisfaction & ix\_salary, ix\_education, returns\_bonus \\
    \midrule
    ix\_employee\_education & Yearly days of education for each employee\\
    ix\_technical\_equipment & Depreciations on IT infrastructure \\
    ix\_service\_time & Customer service time available \\
    ix\_service\_quality & ix\_employee\_education, ix\_service\_time, ix\_technical\_equipment \\
    \midrule
    ix\_fee\_structure & All-in management fee (previous, current, and delta) \\
    \midrule
    ix\_allocation\_coherence & Number of SAA violations and relative TAA discrepancy \\
    \midrule
    ix\_score & ix\_returns, ix\_performance, ix\_allocation\_coherence, ix\_fee\_structure, ix\_service\_quality \\
    \bottomrule
  \end{tabular}
  \centering
  \caption{Overview of all indices calculated in the market model module}
