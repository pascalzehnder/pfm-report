...
The first point of the enumeration above is to be addressed from the IT project team whereas the subsequent two items of the list are the task of the DBF project team.
